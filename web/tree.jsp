...
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"user/Students_queryaction" },
	{ level:2, name:"借阅信息", ico:"images/icon_default.gif",link:"bookinfo/querystudentbookinfo"},
	{ level:1, name:"教师管理"},
	{ level:2, name:"教师列表", ico:"images/icon_default.gif",link:"user/teacher_queryaction"},
    { level:2, name:"借阅信息", ico:"images/icon_default.gif",link:"bookinfo/queryteacherbookinfo"},
    { level:1, name:"图书管理"},
    { level:2, name:"查看图书", ico:"images/icon_default.gif",link:"book/FindBookAction"},
	{ level:2, name:"图书汇入", ico:"images/icon_default.gif",link:"book/ImportExcelAction"},
	{ level:2, name:"图书导出", ico:"images/icon_default.gif",link:"book/OutputExcelAction"},
	{ level:1, name:"座位预选", ico:"images/icon_default.gif",link:"/seat/Seat_select.jsp"},
	{ level:1, name:"数据统计", ico:"images/icon_default.gif",link:"complaint_list.jsp"}
];
</script>
<style>
* {
