...
<head>
    ...
    <script type="text/javascript">
        function login() {
            ...
            targetForm.action = "adminloginaction";
            targetForm.submit();
        }
        function register() {
            targetForm = document.forms[0];
            targetForm.action = "Admin_register.jsp";
            targetForm.submit();
        }
    </script>
</head>
...
<div id="wrapper">
        ...
        <div id="mainBg">
            <div id="mainPanel">
                ...
                <div id="right">
                    ...
                    <s:form name="loginForm" action="adminloginaction" method="post">

                        <div id="welcome">
                            <span id="welcome-text">管&nbsp;理&nbsp;员&nbsp;登&nbsp;录</span>
                        </div>
                        <div id="user-name">
                            <span class="item">账&nbsp;&nbsp;&nbsp;户:</span>
                        ...
                        <div style="margin-top: 110px; margin-left: 110px">
                            <a  href="/user/Users_login.jsp">用户登录</a>
                        </div>
                        <div>
                            <s:fielderror/>
                        </div>
    ...
    <div id="footer">
        <div id="text">朱小龙、潘佳慧、吕云鹏、闫文强</div>
    </div>
</div>
</body>
</html>