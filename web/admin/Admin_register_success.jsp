        ...
        <div id="mainBg">
            <div id="mainPanel">
                ...
                <div id="right">
                    ...
                    <form name="loginForm" action="Admin_login.jsp" method="post">
                        <div id="welcome">
                            <span id="welcome-text">管&nbsp;理&nbsp;员&nbsp;注&nbsp;册</span>
                        </div>
                        <div id="user-name">
                            <span class="item">注册成功！</span>
                        </div>
                        <div id="button-group">
                            <input type="submit" class="btn" value="返回登录">
                        </div>
                        <div>
                            <s:fielderror/>
                        </div>
