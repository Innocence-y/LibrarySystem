...
var treeMenu = [
	{ level:1, name:"图书信息"},
    { level:2, name:"图书列表", ico:"images/icon_default.gif",link:"recommend/recommendBookAction" },
	{ level:1, name:"个人中心"},
	{ level:2, name:"已借书籍", ico:"images/icon_default.gif",link:"bookinfo/personbookinfo"},
    { level:2, name:"个人信息", ico:"images/icon_default.gif",link:"user/Person_query.jsp"},
